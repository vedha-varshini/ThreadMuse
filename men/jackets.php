    ...
    <ul class="desktop-menu-category-list">
      ...
      <li class="menu-category">
        ...
        <ul class="dropdown-list">
          ...
          <li class="dropdown-item">
            <a href="./formals_men.php">Shirt</a>
          </li>

          <li class="dropdown-item">
            <a href="./denims.php">Shorts & Jeans</a>
          </li>
      ...
      <li class="menu-category">
        ...
        <ul class="dropdown-list">
          ...
          <li class="dropdown-item">
            <a href="../women/formal_women.php">Tops</a>
          </li>

          <li class="dropdown-item">
            <a href="../women/formal_women.php"> Pants</a>
          </li>
      ...
      <li class="menu-category">
        <a href="hotoffer.php" class="menu-title">Hot Offers</a>
      </li>
...
<nav class="mobile-navigation-menu  has-scrollbar" data-mobile-menu>
  ...
  <div class="menu-bottom">
    ...
    <ul class="menu-social-container">
      ...
      <div>
      <img src="../assets/images/banner/jackets.png" width="100%">
     
      <div class="product-grid">
      <?php
       $select_query="SELECT *FROM`jackets`";
       ...
       while($row=mysqli_fetch_assoc($result_query)){
        ...
        <div class='product-card'>
          <a href='./product_details.php?product5_id=$product_id'>
          <img src='../admin/product5_images/$product_image1' alt='dress & frock'width='350px'>
