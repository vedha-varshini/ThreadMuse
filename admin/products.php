...
if(isset($_POST['insert_products'])){
    ...
    $product_image1=='' or $product_image2==''or $product_image3==''  ){
       ...
       move_uploaded_file($temp_image1,"product1_images/$product_image1"); 
       move_uploaded_file($temp_image2,"product1_images/$product_image2"); 
       move_uploaded_file($temp_image3,"product1_images/$product_image3"); 

       $insert_products="INSERT INTO `formals_men`(product1_title,product1_description,
       product1_keyword, category_id,product1_image1,product1_image2,product1_image3,product1_price,date,status)
  ...
  rel="stylesheet">
    ...
    <div class="col-md-12">
      <form action="" method="post" enctype="multipart/form-data">
        ...
        <input type="submit" name="insert1_products" class="btn-info mb-3 px-5" value="Insert Products" style="background-color:#fe9929">
